package sesion20250306;

// Ejercicio 2: Sistema de Gestión de APIs REST
// Temática: Consumo de APIs en una aplicación web o móvil.
...
// Crea una interfaz API con el método:
// String obtenerDatos(); → Debe devolver los datos de la API.
// Implementa las clases ApiGitHub y ApiClima que:
...
public class MainThayroneSaldanha {
